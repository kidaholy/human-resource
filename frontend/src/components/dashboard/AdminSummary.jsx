  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        ...
        <SummaryCard icon={<FaBuilding />} text="Total Department" number={4} color="bg-yellow-600" />
        <SummaryCard icon={<FaMoneyBillWave />} text="Monthly Pay" number={"$2500"} color="bg-green-600" />
      </div>
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <SummaryCard icon={<FaUserCheck />} text="Leave Approved" number={5} color="bg-green-600" />
