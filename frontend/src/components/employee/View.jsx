  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 bg-white rounded-md shadow-md overflow-hidden">
      ...
      <div className="relative px-6 py-10">
        ...
        <div className="absolute -top-16 left-6">
          {employee.userId?.profileImage ? (
            ...
            <div className="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center border-4 border-white">
              <span className="text-4xl text-gray-500">{employee.userId?.name?.[0] || "?"}</span>
            </div>
          )}
        </div>
        ...
        {/* Name and title */}
        <div className="mt-16">
          <h1 className="text-3xl font-bold">{employee.userId?.name}</h1>
          <p className="text-gray-600">{employee.designation || "No Designation"}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span>{employee.userId?.email || "No Email"}</span>
            </div>
            <div className="flex items-center gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span>{employee.department?.dep_name || "Not Assigned"}</span>
            </div>
            <div className="flex items-center gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span>DOB: {employee.dob ? new Date(employee.dob).toLocaleDateString() : "Not Available"}</span>
            </div>
            <div className="flex items-center gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium">
                  {new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(employee.salary || 0)}
                </p>
              </div>
            </div>
          </div>
